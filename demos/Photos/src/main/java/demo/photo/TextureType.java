...
public enum TextureType{
	...
	DISPLACE(Iters.of("DISPLACEMENT", "DISPLACE", "HEIGHT")::anyEquals),
	NORMAL(str -> "NORMAL".startsWith(str) || str.matches("^NRM[0-9]*$")),
	ROUGHNESS(Iters.of("ROUGHNESS", "RGH")::anyEquals),
	AMBIENT_OCCLUSION(Iters.of("AO", "AMBIENTOCCLUSION", "OCCLUSION", "AMBIENT_OCCLUSION")::anyEquals),
	ROUGH_AMBIENT_OCCLUSION("ROUGH_AO"::equals),
	MASK(str -> str.matches("^MASK[0-9]*$") || "OPACITY".equals(str)),
	ID("ID"::equals),
	METALNESS(Iters.of("METALNESS", "METALLIC", "METAL")::anyEquals),
