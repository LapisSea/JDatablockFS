...
public final class ContentSupport{
	...
	public static void writeInt4(byte[] writeBuffer, int off, int v){
		...
		writeBuffer[off + 1] = (byte)((v >>> 8)&0xFF);
		writeBuffer[off + 2] = (byte)((v >>> 16)&0xFF);
		writeBuffer[off + 3] = (byte)((v >>> 24)&0xFF);
	}
	...
	public static char readChar2(byte[] readBuffer, int offset){
		return (char)((readBuffer[offset + 0]<<0) +
		              (readBuffer[offset + 1]<<8));
	}
	public static short readInt2(byte[] readBuffer, int offset){
		return (short)(((readBuffer[offset + 0]&255)<<0) +
	...
	public static long readInt8(byte[] readBuffer, int offset){
		return (((long)readBuffer[offset + 0]<<0) +
		        ((long)(readBuffer[offset + 1]&255)<<8) +
		        ((long)(readBuffer[offset + 2]&255)<<16) +
		        ((long)(readBuffer[offset + 3]&255)<<24) +
		        ((long)(readBuffer[offset + 4]&255)<<32) +
		        ...
		        ((long)(readBuffer[offset + 7]&255)<<56));
	}
