package com.lapissea.dfs.old_logger.render;

import com.lapissea.dfs.config.ConfigUtils;
import com.lapissea.dfs.old_logger.AtlasFont;
import com.lapissea.dfs.old_logger.DrawFont;
import com.lapissea.dfs.old_logger.MSDFAtlas;
...
//		glErrorPrint0();
	...
	public OpenGLBackend(){
		this.glThread = makeDisplayThread(this::displayLifecycle);
