...
public class ArrayBoolIOImpl extends VariableNode.ArrayVar<boolean[]>{
	...
	public ArrayBoolIOImpl(VarInfo info, VarHandle valueField, IOStruct.Get.Getter<boolean[]> getFun, IOStruct.Set.Setter<boolean[]> setFun){
		super(info, -1);
	...
	@Override
	protected long getElementsSize(IOInstance target, boolean[] value){
		return BitUtils.bitsToBytes(value.length);
	}
