...
public class DoubleArrayIOImpl extends VariableNode.ArrayVar<double[]>{
	...
	public DoubleArrayIOImpl(VarInfo info, VarHandle valueField, NumberSize elementSize, IOStruct.Get.Getter<double[]> getFun, IOStruct.Set.Setter<double[]> setFun){
		super(info, -1);
