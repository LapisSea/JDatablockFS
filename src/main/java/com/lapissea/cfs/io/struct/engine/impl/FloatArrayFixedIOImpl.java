...
public class FloatArrayFixedIOImpl extends VariableNode.ArrayVar.Fixed<float[]>{
	...
	public FloatArrayFixedIOImpl(VarInfo info, int fixedElementSize, VarHandle valueField, NumberSize elementSize, IOStruct.Get.Getter<float[]> getFun, IOStruct.Set.Setter<float[]> setFun){
