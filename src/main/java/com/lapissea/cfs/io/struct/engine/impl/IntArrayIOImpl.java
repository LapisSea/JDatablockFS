...
public class IntArrayIOImpl extends VariableNode.ArrayVar<int[]>{
	...
	public IntArrayIOImpl(VarInfo info, VarHandle valueField, NumberSize elementSize, IOStruct.Get.Getter<int[]> getFun, IOStruct.Set.Setter<int[]> setFun){
		super(info, -1);
