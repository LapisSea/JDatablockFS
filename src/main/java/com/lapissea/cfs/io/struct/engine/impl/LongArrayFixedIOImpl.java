...
public class LongArrayFixedIOImpl extends VariableNode.ArrayVar.Fixed<long[]>{
	...
	public LongArrayFixedIOImpl(VarInfo info, int fixedElementSize, VarHandle valueField, NumberSize elementSize, IOStruct.Get.Getter<long[]> getFun, IOStruct.Set.Setter<long[]> setFun){
