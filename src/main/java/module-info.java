module JDatablockFS {
	...
	exports com.lapissea.cfs.type.field to JDatablockFS.tools;
	exports com.lapissea.cfs.type.field.access to JDatablockFS.tools;
	
	exports com.lapissea.cfs.type.field.fields.reflection to JDatablockFS.tools;
}
